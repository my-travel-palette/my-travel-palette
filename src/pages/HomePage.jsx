  ...
  return (
    <div>
      ...
      <div className="bg-base-200 p-6 rounded-lg shadow-md text-base-content font-sans leading-relaxed text-lg">
        <p className="mb-4">
          Welcome to <span className="font-bold text-emerald-800">My Travel Palette</span> — a
          place where <span className="font-semibold">Sevda</span> and{" "}
          <span className="font-semibold">Kateryna</span> share their journeys,
          colors, and stories from around the world.
        </p>

        <p className="mb-4">
          This blog is more than just about destinations. It is a personal diary
          of the skies we have admired, the streets we have wandered, and the
          cultures that have shaped us. Each trip adds a brushstroke to the
          canvas of our lives — a memory, a feeling, a moment worth remembering.
        </p>
